...
No preciso el rito de la misa entera,
si en tu presencia todo es fe`,

  `Hice fila en el silencio para encontrarte,
y al final de mis dudas levanté las manos
al último suspiro, como quien ya no pide,
sino se entrega por completo`,
...
la vida tuvo la delicadeza de acercarme a ti`,
  ...
  `Si alguna vez escriben sobre las cosas hermosas que salvan a un hombre,
espero que hablen de tus ojos, de tu manera de tomar mi mano
y de esa ternura tuya que volvió más amable incluso mis días más tristes`,

  `Tal vez nunca encuentre palabras suficientes para explicarte lo que provocas en mí,
porque hay sentimientos demasiado grandes para caber en un idioma.
Pero si algún día dudas, recuerda esto:
desde que existes en mi vida, el mundo pesa un poco menos`
];
